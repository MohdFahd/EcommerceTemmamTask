                    ...
                    <div class="card-body p-3">
                        <div class="row">
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="/Admin/assets/img/shapes/waves-white.svg"
                                    ...
                                    >
                                        <img
                                            ...
                                            src="/Admin/assets/img/illustrations/rocket-white.png"
                                            alt="rocket"
                                        />
                                    </div>
                                </div>
            ...
            <div class="col-lg-5">
                <div class="card h-100 p-3">
                    <div
                        ...
                        style="
                            background-image: url('/Admin/assets/img/ivancik.jpg');
                        "
                    >
                ...
                <div class="card z-index-2">
                    <div class="card-body p-3">
                        ...
                        <p class="text-sm ms-2">
                            (<span class="font-weight-bolder">+23%</span>) than
                            last week
                        </p>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="/Admin/assets/img/small-logos/logo-xd.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="/Admin/assets/img/small-logos/logo-atlassian.svg"
                                                        class="avatar avatar-sm me-3"
                                                        alt="atlassian"
                                                    />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="/Admin/assets/img/small-logos/logo-slack.svg"
                                                        class="avatar avatar-sm me-3"
                                                        alt="team7"
                                                    />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="/Admin/assets/img/small-logos/logo-spotify.svg"
                                                        class="avatar avatar-sm me-3"
                                                        alt="spotify"
                                                    />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="/Admin/assets/img/small-logos/logo-jira.svg"
                                                        class="avatar avatar-sm me-3"
                                                        alt="jira"
                                                    />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="/Admin/assets/img/small-logos/logo-invision.svg"
                                                        class="avatar avatar-sm me-3"
                                                        alt="invision"
                                                    />
                                                </div>
